...
<div class="container-fluid">										<!--sine up  start -->
	<div class="header">
		<div class="row">
					...
					<div class="modal-dialog">
						<div class="modal-content title1">
							<div class="modal-header">
								h4 class="modal-title title1"><span style="color:orange">SINE UP</span></h4>
			...
			<div class="col-md-12">
				<input id="name" name="name" placeholder="Enter your name" class="form-control input-md" type="name">
			</div>
									</div>
				<div class="form-group">
					<label class="col-md-3 control-label" for="gender"></label>  
					<div class="col-md-12">
						<input id="gender" name="gender" placeholder="Enter your gender" class="form-control input-md" type="gender">
					</div>
				</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input id="course" name="course" placeholder="Enter your course/year" class="form-control input-md" type="course">
						</div>
					</div>
					  <div class="form-group">
						<label class="col-md-3 control-label" for="mob"></label>  
						<div class="col-md-12">
						<input id="mob" name="mob" placeholder="Enter your mob" class="form-control input-md" type="mob">
						</div>
					  </div>
					<!-- Password input-->
					<div class="form-group">
...
<div class="header">
		...
		<div class="col-lg-12">
			...
			<div class="modal fade" id="myModa3">
			  <div class="modal-dialog">
				<div class="modal-content title1">
					<div class="modal-header">
						<h4 class="modal-title title1"><span style="color:orange">admin login</span></h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					</div>
				  	<div class="modal-body">
	...
	<div class="container mt-5">
		<h1 class="text-center mt-4" style="font-family: Georgia, 'Times New Roman', Times, serif;"><span>OUR TEAM</span></h1>
